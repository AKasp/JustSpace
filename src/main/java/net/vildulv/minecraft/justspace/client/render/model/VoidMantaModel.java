package net.vildulv.minecraft.justspace.client.render.model;
...
public class VoidMantaModel <T extends VoidMantaEntity> extends HierarchicalModel<T> {
    ...
    public VoidMantaModel(ModelPart root) {
        this.root = root;
